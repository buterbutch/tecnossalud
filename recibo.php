...
<html lang="es">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light p-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
              <span class="text-primary fs-5 fw-bold">Tecno-saluD.</span>
            </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#fff">Registro</a>
              </li>
            </ul>
 ...
 <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  ...
  <section class="w-50 mx-auto text-center pt-5" id="intro">
    <h1 class="p-3 fs-2 border-top border-3"> <span class="text-primary fs-5 fw-bold">Meta-saluD.</span> Es una agencia unica para suplir necesidades de las entidades prestadoras de servcios en salud.</h1>
  ...
  <section class="container-fluid">
   ...
   <section id="seccion-contacto">
     ...
     <div class="container" id="contenedor-formulario">
      ...
      <p class="fs-5">Estamos para ayudarte en tu trabajo.</p></div>

       </div>

    </div>
<form action="recibo.php" method="POST">
  <div class="hhh" id="fff">

    <h4>Formulario registro.</h4>

    <input class="controls w-100" type="text" name="nombres" id="nombres" placeholder="Ingrse su Nombre">
    <input class="controls w-100" type="text" name="apellidos" id="apellidos" placeholder="Ingrse su Apellido">
    <input class="controls w-100" type="email" name="correo" id="correo" placeholder="Ingrse su Correo">
    <input class="controls w-100" type="password" name="contraseña" id="contraseña" placeholder="Ingrse su contraseña">
